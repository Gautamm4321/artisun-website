...
export default function ClimateModelSection() {
  ...
  return (
    ...
    >
     ...
     {/* 3. Model Cutout: Balanced Clearance for Mobile, Grand Bleed on Laptop */}
      ...
      {/* 4. Top-Left & Mid-Left Split Typography (Top-Ceiling Locked, Zero Overlap on Model Face) */}
