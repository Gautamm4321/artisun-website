...
export default function SkinwearDailyLife() {
  return (
    <section className="relative z-[15] w-full min-h-[100svh] flex flex-col justify-center px-6 md:px-16 lg:px-20 py-24 md:py-28">
      <h2 className="font-editorial text-[var(--brand-cream)] uppercase text-[clamp(1.7rem,3.1vw,3.8rem)] leading-[1.15] tracking-[-0.02em] text-justify [text-align-last:justify] w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_1.6fr_1fr] gap-10 md:gap-12 items-center mt-12 md:mt-16">
        ...
        <div className="order-2 md:order-1">
          <p className="font-suisse text-[var(--brand-cream)] text-[18px] md:text-[20px] lg:text-[22px] leading-[1.4]">
            <span className="font-editorial text-[clamp(1.5rem,2vw,2rem)]">
              Skinwear&trade;
            </span>{' '}
            <br className="hidden md:block" />
            is more than a formula inside a bottle. It is different answers for
            different mornings, all held to the same climate-smart standard.
          </p>
        </div>

        {/* Centre product image + CTA */}
        <div className="order-1 md:order-2 flex flex-col items-center gap-8">
          <div className="relative w-full max-w-[560px] aspect-[4/3] overflow-hidden shadow-[0_50px_100px_-40px_rgba(0,0,0,0.55)]">
            <Image
        ...
        <div className="order-3 md:order-3">
          <p className="font-suisse text-[var(--brand-cream)] text-[18px] md:text-[20px] lg:text-[22px] leading-[1.4] text-left md:text-right">
            The texture matters. The weight in your hand matters. The way the
            bottle sits on a shelf next to your other essentials matters. We
            make these decisions with the same care a tailor brings to a
            garment.
          </p>
        </div>
      </div>
