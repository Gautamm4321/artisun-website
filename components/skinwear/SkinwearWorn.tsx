  ...
  return (
    <section className="relative z-[15] w-full min-h-[100svh] flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 md:px-16 lg:px-20 py-20 md:py-0">
        ...
        <p className="font-suisse text-[var(--brand-cream)]/90 text-[18px] md:text-[21px] lg:text-[24px] leading-[1.4] text-justify mt-10 md:mt-14 max-w-[26em]">
          Chosen with the same intent as an outfit, and worthy of the same
          attention. We are not making suncare that you tolerate as a
          treatment. We are making the thing you&apos;d want to wear, talk
          about, and be seen in.
        </p>
      </div>

      {/* Right — full-height image */}
      <div className="relative w-full md:w-[38%] lg:w-[35%] h-[62svh] md:h-auto md:min-h-[100svh]">
        <Image
