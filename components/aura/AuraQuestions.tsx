...
function renderAnswerContent(answer: string) {
    if (answer === 'INCI_SPECIAL') {
        return (
            <div>
                <p>
                    Aura is a hydrating gel with SPF pearls. The sun protection comes from three UV filters (ethylhexyl methoxycinnamate, ethylhexyl salicylate, and diethylamino hydroxybenzoyl hexyl benzoate / Uvinul A Plus), and the hydration from sodium hyaluronate and ectoin.
                </p>
            ...
            <div>
                ...
                <ul className="mt-2.5 space-y-2 pl-1">
                    <li className="relative pl-4 text-[var(--brand-cream)]/90 before:content-[''] before:absolute before:left-0 before:top-2.5 before:w-1.5 before:h-1.5 before:rounded-full before:bg-[var(--brand-red)]">
                        <strong className="text-[var(--brand-cream)] font-semibold">Ectoin</strong> (Germany) — a K-beauty hero that deeply hydrates (up to a 3x moisture boost) and shields skin from heat, pollution, and UV stress.
                    </li>
                    <li className="relative pl-4 text-[var(--brand-cream)]/90 before:content-[''] before:absolute before:left-0 before:top-2.5 before:w-1.5 before:h-1.5 before:rounded-full before:bg-[var(--brand-red)]">
                        <strong className="text-[var(--brand-cream)] font-semibold">Hyaluronic acid</strong> (sodium hyaluronate) — pulls water into the skin and holds it, for a plump, dewy softness. It&apos;s the reason Aura finishes the way it does.
                    </li>
                    <li className="relative pl-4 text-[var(--brand-cream)]/90 before:content-[''] before:absolute before:left-0 before:top-2.5 before:w-1.5 before:h-1.5 before:rounded-full before:bg-[var(--brand-red)]">
                        <strong className="text-[var(--brand-cream)] font-semibold">Bisabolol</strong> (from chamomile) — calms redness and keeps the finish even.
                    </li>
                    <li className="relative pl-4 text-[var(--brand-cream)]/90 before:content-[''] before:absolute before:left-0 before:top-2.5 before:w-1.5 before:h-1.5 before:rounded-full before:bg-[var(--brand-red)]">
                        <strong className="text-[var(--brand-cream)] font-semibold">Uvinul A Plus</strong> (Germany) — one of the world&apos;s most advanced UVA filters, photostable for up to 8 hours.
                    </li>
                </ul>
...
export default function AuraQuestions() {
    ...
    return (
        <div
            id="aura-questions"
            className="aura-panel relative w-full lg:w-screen shrink-0 h-[100svh] lg:h-screen flex items-start overflow-y-auto"
            style={{
                pointerEvents: 'auto',
        ...
        >
            <div className="w-full max-w-[920px] mx-auto px-5 sm:px-8 lg:px-14 pt-20 lg:pt-[90px] pb-24 flex flex-col my-auto">
                ...
                <p className="self-center font-suisse text-[var(--brand-cream)]/85 text-sm sm:text-base mt-3 text-center max-w-[54ch] leading-relaxed">
                    Straight answers about Aura Pearl Skinwear — what it is, how the <br className="hidden sm:inline" />
                    pearls work by weather, how it protects and glows, and what&apos;s inside.
                </p>

                {/* Spec Badges */}
                <div className="flex flex-wrap gap-2 justify-center mt-5">
                    {['SPF 40 · PA+++', 'Gel + SPF pearls', 'Dewy glow, no shimmer', 'Deeply hydrating', '50 g', 'Made in India', '₹1,799'].map((spec) => (
                        <span
                            key={spec}
                ...
                <div className="w-full mt-14 sm:mt-16 pt-2 pb-10">
                    <div className="w-full bg-[#8B2325] text-[var(--brand-cream)] rounded-[14px] px-6 sm:px-12 py-10 sm:py-12 text-center border border-white/10 shadow-2xl">
                        ...
                        <p className="font-suisse text-[14px] sm:text-[15.5px] leading-relaxed text-[var(--brand-cream)]/85 max-w-[46ch] mx-auto mb-6">
                            Aura is protection with a glow — the one for days you want a little more.
                        </p>
                        <a
                            href="#buy"
