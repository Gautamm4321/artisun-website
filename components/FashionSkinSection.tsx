    ...
    return (
        ...
        >
           ...
           {/* Text Block — Shifted Left */}
            <div className="absolute top-[24%] sm:top-[26%] lg:top-[28%] left-1/2 -translate-x-[115%] sm:-translate-x-[125%] lg:-translate-x-[130%] z-30 max-w-[280px] sm:max-w-[340px] pointer-events-auto text-left">
