  ...
  return (
    ...
    >
      ...
      <nav className="flex items-center gap-3 sm:gap-4 md:gap-8 pointer-events-auto">
        <Link
          href="/climate"
          className="font-editorial text-[var(--brand-cream)] text-sm md:text-[19px] hover:opacity-70 transition-opacity whitespace-nowrap"
        >
          Climate-smart
        </Link>

        {/* Product icons — first (bottle) links to Origin; hidden on the smallest screens */}
